...
import {
  ...
  ArrowBack as ArrowBackIcon, Face, AirlineSeatFlat, PeopleOutline, ListAlt, HdrWeak, DirectionsWalk,
...
const structure = [
  ...
  { id: 1, label: 'Patient Details', link: '/app/typography', icon: <Face /> },
  { id: 2, label: 'Admission', link: '/app/tables', icon: <AirlineSeatFlat /> },
  { id: 3, label: 'Orders', link: '/app/notifications', icon: <NotificationsIcon />},
  {
    id: 4,
    label: 'Documentation',
    link: '/app/ui',
  ...
  { id: 5, label: 'Referral', link: '/app/referral', icon: <PeopleOutline />},
  { id: 6, label: 'Results', link: '/app/results', icon: <ListAlt />},
  { id: 7, label: 'Medication', link: '/app/medication', icon: <HdrWeak />},
  { id: 8, label: 'Discharge', link: '/app/discharge', icon: <DirectionsWalk />},
  { id: 9, type: 'divider' },
